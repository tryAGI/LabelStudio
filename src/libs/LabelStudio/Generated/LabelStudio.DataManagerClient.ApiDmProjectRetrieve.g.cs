...
namespace LabelStudio
{
    public partial class DataManagerClient
    {
        ...
        partial void ProcessApiDmProjectRetrieveResponse(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApiDmProjectRetrieveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiDmProjectRetrieve",
                                methodName: "ApiDmProjectRetrieveAsync",
                                pathTemplate: "\"/api/dm/project/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiDmProjectRetrieveResponse(
                    httpClient: HttpClient,
