...
{
    public partial class SessionPolicyClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.SessionTimeoutPolicy> UpdateAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.SessionTimeoutPolicy>> UpdateAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "\"/api/session-policy/\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.SessionTimeoutPolicy.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.SessionTimeoutPolicy>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.SessionTimeoutPolicy.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LabelStudio.PatchedSessionTimeoutPolicyRequest
            {
                ...
                MaxTimeBetweenActivity = maxTimeBetweenActivity,
            };
