...
namespace LabelStudio
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::LabelStudio.AutoSDKRetryOptions Retry { get; set; } = new global::LabelStudio.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::LabelStudio.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::LabelStudio.IAutoSDKHook>();
        ...
        public global::LabelStudio.AutoSDKClientOptions AddHook(
            global::LabelStudio.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::LabelStudio.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::LabelStudio.AutoSDKClientOptions UseAuthorizationProvider(
            global::LabelStudio.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::LabelStudio.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::LabelStudio.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::LabelStudio.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::LabelStudio.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::LabelStudio.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::LabelStudio.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::LabelStudio.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::LabelStudio.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::LabelStudio.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::LabelStudio.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::LabelStudio.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::LabelStudio.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::LabelStudio.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::LabelStudio.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::LabelStudio.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::LabelStudio.AutoSDKHookContext CreateHookContext(
            ...
            global::LabelStudio.AutoSDKClientOptions clientOptions,
            global::LabelStudio.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::LabelStudio.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::LabelStudio.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::LabelStudio.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::LabelStudio.AutoSDKClientOptions clientOptions,
            global::System.Func<global::LabelStudio.IAutoSDKHook, global::LabelStudio.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::LabelStudio.AutoSDKHookContext context)
        {
