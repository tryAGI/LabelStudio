...
namespace LabelStudio
{
    public partial class AwsClient
    {
        ...
        {
            var __response = await LogsAsResponseAsync(
                id: id,
                endDate: endDate,
                limit: limit,
                startDate: startDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<string>> LogsAsResponseAsync(
            int id,
            string? endDate = default,
            int? limit = default,
            string? startDate = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Logs",
                                methodName: "LogsAsync",
                                pathTemplate: "$\"/api/projects/{id}/aws-custom-function-logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
