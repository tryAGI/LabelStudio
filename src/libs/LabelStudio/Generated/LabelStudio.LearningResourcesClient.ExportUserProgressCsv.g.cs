...
namespace LabelStudio
{
    public partial class LearningResourcesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ExportUserProgressCsvSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ExportUserProgressCsvSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ExportUserProgressCsvSecurityRequirement0,
            };
        partial void PrepareExportUserProgressCsvArguments(
            ...
            ref string? search,
            ref string? status);
        partial void PrepareExportUserProgressCsvRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? search,
            string? status);
        partial void ProcessExportUserProgressCsvResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExportUserProgressCsvResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);

        /// <summary>
        /// ✨ Export user progress for a learning resource<br/>
        ...
        ///         &lt;/p&gt;<br/>
        ///     &lt;/Card&gt;<br/>
        /// Export filtered course learner progress as CSV.
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<byte[]> ExportUserProgressCsvAsync(
            int id,
        ...
        {
            var __response = await ExportUserProgressCsvAsResponseAsync(
                id: id,
                columns: columns,
                ordering: ordering,
                search: search,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> ExportUserProgressCsvAsStreamAsync(
            int id,
            string? columns = default,
            string? ordering = default,
            string? search = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareExportUserProgressCsvArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExportUserProgressCsvSecurityRequirements,
                operationName: "ExportUserProgressCsvAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: $"/api/learning-resources/{id}/user-progress/export/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExportUserProgressCsvRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExportUserProgressCsv",
                                methodName: "ExportUserProgressCsvAsync",
                                pathTemplate: "$\"/api/learning-resources/{id}/user-progress/export/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExportUserProgressCsvResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<byte[]>> ExportUserProgressCsvAsResponseAsync(
            int id,
            string? columns = default,
            string? ordering = default,
            string? search = default,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExportUserProgressCsvResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
