...
namespace LabelStudio
{
    ...
    public sealed partial class ApiProjectsTasksAssigneesCreateRequestSelectedItemsAllTrue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiProjectsTasksAssigneesCreateRequestSelectedItemsAllTrue" /> class.
        /// </summary>
        /// <param name="all">
        /// All tasks are selected
        /// </param>
...
#endif
        public ApiProjectsTasksAssigneesCreateRequestSelectedItemsAllTrue(
            bool all,
