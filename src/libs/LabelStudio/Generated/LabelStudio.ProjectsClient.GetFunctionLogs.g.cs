...
namespace LabelStudio
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_GetFunctionLogsSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_GetFunctionLogsSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_GetFunctionLogsSecurityRequirement0,
            };
        partial void PrepareGetFunctionLogsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? endDate,
            ref int id,
            ref int? limit,
            ref string? startDate);
        partial void PrepareGetFunctionLogsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? startDate);
        partial void ProcessGetFunctionLogsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFunctionLogsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// ✨ Get custom metric function logs<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> GetFunctionLogsAsync(
            int id,
        ...
        {
            var __response = await GetFunctionLogsAsResponseAsync(
                id: id,
                endDate: endDate,
                limit: limit,
                startDate: startDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<string>> GetFunctionLogsAsResponseAsync(
            int id,
            string? endDate = default,
            int? limit = default,
            string? startDate = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFunctionLogsArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFunctionLogsSecurityRequirements,
                operationName: "GetFunctionLogsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetFunctionLogsAsync",
                                pathTemplate: "$\"/api/projects/{id}/custom-function-logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFunctionLogsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFunctionLogsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
