...
namespace LabelStudio
{
    public partial class StatesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_OrganizationIdpAssignmentsHistorySecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_OrganizationIdpAssignmentsHistorySecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_OrganizationIdpAssignmentsHistorySecurityRequirement0,
            };
        partial void PrepareOrganizationIdpAssignmentsHistoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? groupName,
            ref global::LabelStudio.ApiFsmOrganizationsIdpAssignmentsHistoryListKind? kind,
            ref string? ordering,
            ref int orgId,
            ref int? page,
            ref int? pageSize,
        ...
        partial void PrepareOrganizationIdpAssignmentsHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? groupName,
            global::LabelStudio.ApiFsmOrganizationsIdpAssignmentsHistoryListKind? kind,
            string? ordering,
            int orgId,
            int? page,
            int? pageSize,
        ...
        partial void ProcessOrganizationIdpAssignmentsHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOrganizationIdpAssignmentsHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.PaginatedStateModelList> OrganizationIdpAssignmentsHistoryAsync(
            int orgId,
        ...
        {
            var __response = await OrganizationIdpAssignmentsHistoryAsResponseAsync(
                orgId: orgId,
                groupName: groupName,
                kind: kind,
                ordering: ordering,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.PaginatedStateModelList>> OrganizationIdpAssignmentsHistoryAsResponseAsync(
            int orgId,
            string? groupName = default,
            global::LabelStudio.ApiFsmOrganizationsIdpAssignmentsHistoryListKind? kind = default,
            string? ordering = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOrganizationIdpAssignmentsHistoryArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OrganizationIdpAssignmentsHistorySecurityRequirements,
                operationName: "OrganizationIdpAssignmentsHistoryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: $"/api/fsm/organizations/{orgId}/idp-assignments-history/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOrganizationIdpAssignmentsHistoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OrganizationIdpAssignmentsHistory",
                                methodName: "OrganizationIdpAssignmentsHistoryAsync",
                                pathTemplate: "$\"/api/fsm/organizations/{orgId}/idp-assignments-history/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOrganizationIdpAssignmentsHistoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOrganizationIdpAssignmentsHistoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
