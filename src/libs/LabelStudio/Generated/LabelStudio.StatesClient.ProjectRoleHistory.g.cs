...
namespace LabelStudio
{
    public partial class StatesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ProjectRoleHistorySecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ProjectRoleHistorySecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ProjectRoleHistorySecurityRequirement0,
            };
        partial void PrepareProjectRoleHistoryArguments(
            ...
            ref int? userId);
        partial void PrepareProjectRoleHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? userId);
        partial void ProcessProjectRoleHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectRoleHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.PaginatedStateModelList> ProjectRoleHistoryAsync(
            int projectId,
        ...
        {
            var __response = await ProjectRoleHistoryAsResponseAsync(
                projectId: projectId,
                ordering: ordering,
                page: page,
                pageSize: pageSize,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.PaginatedStateModelList>> ProjectRoleHistoryAsResponseAsync(
            int projectId,
            string? ordering = default,
            int? page = default,
            int? pageSize = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectRoleHistoryArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectRoleHistorySecurityRequirements,
                operationName: "ProjectRoleHistoryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: $"/api/fsm/projects/{projectId}/role-history/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectRoleHistoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectRoleHistory",
                                methodName: "ProjectRoleHistoryAsync",
                                pathTemplate: "$\"/api/fsm/projects/{projectId}/role-history/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectRoleHistoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectRoleHistoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
