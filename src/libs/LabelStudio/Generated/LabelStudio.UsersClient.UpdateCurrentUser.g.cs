            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LabelStudio.LseUserAPI.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LabelStudio.LseUserAPI.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
