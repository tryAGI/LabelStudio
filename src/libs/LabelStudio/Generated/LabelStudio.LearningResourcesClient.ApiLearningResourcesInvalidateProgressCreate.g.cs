...
namespace LabelStudio
{
    public partial class LearningResourcesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiLearningResourcesInvalidateProgressCreateSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiLearningResourcesInvalidateProgressCreateSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ApiLearningResourcesInvalidateProgressCreateSecurityRequirement0,
            };
        ...
        /// <summary>
        /// ✨ Invalidate progress for a learning resource<br/>
        ...
        ///         &lt;/p&gt;<br/>
        ///     &lt;/Card&gt;<br/>
        /// Invalidate all learner progress for a learning resource.
        /// </summary>
        /// <param name="id"></param>
        ...
        {
            await ApiLearningResourcesInvalidateProgressCreateAsResponseAsync(
                id: id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApiLearningResourcesInvalidateProgressCreateArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiLearningResourcesInvalidateProgressCreateSecurityRequirements,
                operationName: "ApiLearningResourcesInvalidateProgressCreateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: $"/api/learning-resources/{id}/invalidate-progress/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApiLearningResourcesInvalidateProgressCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiLearningResourcesInvalidateProgressCreate",
                                methodName: "ApiLearningResourcesInvalidateProgressCreateAsync",
                                pathTemplate: "$\"/api/learning-resources/{id}/invalidate-progress/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiLearningResourcesInvalidateProgressCreateResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await ApiLearningResourcesInvalidateProgressCreateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
