            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LabelStudio.RoleBasedTask.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LabelStudio.RoleBasedTask.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
