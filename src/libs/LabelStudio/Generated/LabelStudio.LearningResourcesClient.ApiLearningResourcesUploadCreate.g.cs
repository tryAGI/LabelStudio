...
namespace LabelStudio
{
    public partial class LearningResourcesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiLearningResourcesUploadCreateSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiLearningResourcesUploadCreateSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ApiLearningResourcesUploadCreateSecurityRequirement0,
            };
        ...
        partial void ProcessApiLearningResourcesUploadCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// ✨ Upload a file for a learning resource<br/>
        ...
        ///         &lt;/p&gt;<br/>
        ///     &lt;/Card&gt;<br/>
        /// Upload a file asset for use in a learning resource.
        /// </summary>
        /// <param name="id"></param>
        ...
        {
            var __response = await ApiLearningResourcesUploadCreateAsResponseAsync(
                id: id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApiLearningResourcesUploadCreateArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiLearningResourcesUploadCreateSecurityRequirements,
                operationName: "ApiLearningResourcesUploadCreateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: $"/api/learning-resources/{id}/upload/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApiLearningResourcesUploadCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiLearningResourcesUploadCreate",
                                methodName: "ApiLearningResourcesUploadCreateAsync",
                                pathTemplate: "$\"/api/learning-resources/{id}/upload/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiLearningResourcesUploadCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiLearningResourcesUploadCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.LearningResourceUploadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.LearningResourceUploadResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.LearningResourceUploadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ApiLearningResourcesUploadCreateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
