...
namespace LabelStudio
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiInferenceRunsReEvaluateCreateSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiInferenceRunsReEvaluateCreateSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ApiInferenceRunsReEvaluateCreateSecurityRequirement0,
            };
        partial void PrepareApiInferenceRunsReEvaluateCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LabelStudio.ReEvaluateRequest request);
        partial void PrepareApiInferenceRunsReEvaluateCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LabelStudio.ReEvaluateRequest request);
        partial void ProcessApiInferenceRunsReEvaluateCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessApiInferenceRunsReEvaluateCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.ReEvaluate> ApiInferenceRunsReEvaluateCreateAsync(

            global::LabelStudio.ReEvaluateRequest request,
            global::LabelStudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ApiInferenceRunsReEvaluateCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ReEvaluate>> ApiInferenceRunsReEvaluateCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApiInferenceRunsReEvaluateCreateArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiInferenceRunsReEvaluateCreateSecurityRequirements,
                operationName: "ApiInferenceRunsReEvaluateCreateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiInferenceRunsReEvaluateCreate",
                                methodName: "ApiInferenceRunsReEvaluateCreateAsync",
                                pathTemplate: "\"/api/inference-runs/re-evaluate/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiInferenceRunsReEvaluateCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiInferenceRunsReEvaluateCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.ReEvaluate.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ReEvaluate>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.ReEvaluate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.ReEvaluate> ApiInferenceRunsReEvaluateCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LabelStudio.ReEvaluateRequest
            {
                Mode = mode,
                ModelVersionId = modelVersionId,
                RunBId = runBId,
                SourceModelRunId = sourceModelRunId,
                TaskIds = taskIds,
            };

            return await ApiInferenceRunsReEvaluateCreateAsync(
                request: __request,
                requestOptions: requestOptions,
