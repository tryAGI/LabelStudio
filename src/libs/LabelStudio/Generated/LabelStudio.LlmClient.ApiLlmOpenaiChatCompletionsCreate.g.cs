...
namespace LabelStudio
{
    public partial class LlmClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiLlmOpenaiChatCompletionsCreateSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiLlmOpenaiChatCompletionsCreateSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
        ...
        partial void ProcessApiLlmOpenaiChatCompletionsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ApiLlmOpenaiChatCompletionsCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApiLlmOpenaiChatCompletionsCreateArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiLlmOpenaiChatCompletionsCreateSecurityRequirements,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiLlmOpenaiChatCompletionsCreate",
                                methodName: "ApiLlmOpenaiChatCompletionsCreateAsync",
                                pathTemplate: "\"/api/llm/openai/chat/completions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiLlmOpenaiChatCompletionsCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiLlmOpenaiChatCompletionsCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ApiLlmOpenaiChatCompletionsCreateAsync(
                request: __request,
                requestOptions: requestOptions,
