...
namespace LabelStudio
{
    public partial class LearningResourcesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiLearningResourcesRetrieveSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiLearningResourcesRetrieveSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ApiLearningResourcesRetrieveSecurityRequirement0,
            };
        ...
        partial void ProcessApiLearningResourcesRetrieveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ApiLearningResourcesRetrieveAsResponseAsync(
                id: id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareApiLearningResourcesRetrieveArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiLearningResourcesRetrieveSecurityRequirements,
                operationName: "ApiLearningResourcesRetrieveAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApiLearningResourcesRetrieveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiLearningResourcesRetrieve",
                                methodName: "ApiLearningResourcesRetrieveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiLearningResourcesRetrieveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiLearningResourcesRetrieveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
