...
namespace LabelStudio
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiPromptsVersionsDuplicateCreateSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiPromptsVersionsDuplicateCreateSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ApiPromptsVersionsDuplicateCreateSecurityRequirement0,
            };
        partial void PrepareApiPromptsVersionsDuplicateCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int promptId,
            ref int versionId,
            global::LabelStudio.ThirdPartyModelVersionRequest request);
        partial void PrepareApiPromptsVersionsDuplicateCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int promptId,
            int versionId,
            global::LabelStudio.ThirdPartyModelVersionRequest request);
        partial void ProcessApiPromptsVersionsDuplicateCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessApiPromptsVersionsDuplicateCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.ThirdPartyModelVersion> ApiPromptsVersionsDuplicateCreateAsync(
            int promptId,
            int versionId,
        ...
        {
            var __response = await ApiPromptsVersionsDuplicateCreateAsResponseAsync(
                promptId: promptId,
                versionId: versionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ThirdPartyModelVersion>> ApiPromptsVersionsDuplicateCreateAsResponseAsync(
            int promptId,
            int versionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApiPromptsVersionsDuplicateCreateArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiPromptsVersionsDuplicateCreateSecurityRequirements,
                operationName: "ApiPromptsVersionsDuplicateCreateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: $"/api/prompts/{promptId}/versions/{versionId}/duplicate",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiPromptsVersionsDuplicateCreate",
                                methodName: "ApiPromptsVersionsDuplicateCreateAsync",
                                pathTemplate: "$\"/api/prompts/{promptId}/versions/{versionId}/duplicate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiPromptsVersionsDuplicateCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiPromptsVersionsDuplicateCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.ThirdPartyModelVersion.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ThirdPartyModelVersion>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.ThirdPartyModelVersion.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ApiPromptsVersionsDuplicateCreateAsync(
                promptId: promptId,
                versionId: versionId,
                request: __request,
                requestOptions: requestOptions,
