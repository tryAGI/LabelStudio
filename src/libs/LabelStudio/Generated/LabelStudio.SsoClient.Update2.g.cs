            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LabelStudio.ScimSettingsUpdate.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LabelStudio.ScimSettingsUpdate.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
