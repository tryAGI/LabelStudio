            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LabelStudio.AgreementV2BackfillJob.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LabelStudio.AgreementV2BackfillJob.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
