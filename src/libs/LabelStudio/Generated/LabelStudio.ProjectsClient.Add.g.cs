...
namespace LabelStudio
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_AddSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_AddSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
        ...
        partial void PrepareAddArguments(
            ...
            ref int id,
            global::LabelStudio.ProjectMemberRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.ProjectMember> AddAsync(
            int id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ProjectMember>> AddAsResponseAsync(
            int id,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::LabelStudio.ProjectMemberIdentityVerificationError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::LabelStudio.ProjectMemberIdentityVerificationError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LabelStudio.ApiException<global::LabelStudio.ProjectMemberIdentityVerificationError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.ProjectMember.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ProjectMember>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.ProjectMember.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.ProjectMember> AddAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LabelStudio.ProjectMemberRequest
            {
                User = user,
            };
