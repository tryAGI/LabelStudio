...
namespace LabelStudio
{
    public partial class DatasetStorageGcsClient
    {
        ...
        partial void PrepareApiDatasetStoragesGcsPartialUpdateArguments(
            ...
            ref int id,
            global::LabelStudio.PatchedGCSDatasetStorageRequest request);
        partial void PrepareApiDatasetStoragesGcsPartialUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::LabelStudio.PatchedGCSDatasetStorageRequest request);
        partial void ProcessApiDatasetStoragesGcsPartialUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessApiDatasetStoragesGcsPartialUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.GCSDatasetStorage> ApiDatasetStoragesGcsPartialUpdateAsync(
            int id,
        ...
        {
            var __response = await ApiDatasetStoragesGcsPartialUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.GCSDatasetStorage>> ApiDatasetStoragesGcsPartialUpdateAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApiDatasetStoragesGcsPartialUpdateArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApiDatasetStoragesGcsPartialUpdateRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiDatasetStoragesGcsPartialUpdate",
                                methodName: "ApiDatasetStoragesGcsPartialUpdateAsync",
                                pathTemplate: "$\"/api/dataset-storages/gcs/{id}/\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiDatasetStoragesGcsPartialUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.GCSDatasetStorage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.GCSDatasetStorage>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.GCSDatasetStorage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.GCSDatasetStorage> ApiDatasetStoragesGcsPartialUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LabelStudio.PatchedGCSDatasetStorageRequest
            {
                Bucket = bucket,
                Dataset = dataset,
            ...
            return await ApiDatasetStoragesGcsPartialUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
