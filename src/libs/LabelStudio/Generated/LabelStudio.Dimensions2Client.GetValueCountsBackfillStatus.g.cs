...
namespace LabelStudio
{
    public partial class Dimensions2Client
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_GetValueCountsBackfillStatusSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_GetValueCountsBackfillStatusSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_GetValueCountsBackfillStatusSecurityRequirement0,
            };
        partial void PrepareGetValueCountsBackfillStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? jobId,
            ref int? projectId);
        partial void PrepareGetValueCountsBackfillStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? jobId,
            int? projectId);
        partial void ProcessGetValueCountsBackfillStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetValueCountsBackfillStatusResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.ValueCountsBackfillJob> GetValueCountsBackfillStatusAsync(
            int? jobId = default,
            int? projectId = default,
            global::LabelStudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetValueCountsBackfillStatusAsResponseAsync(
                jobId: jobId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ValueCountsBackfillJob>> GetValueCountsBackfillStatusAsResponseAsync(
            int? jobId = default,
            int? projectId = default,
            global::LabelStudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetValueCountsBackfillStatusArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetValueCountsBackfillStatusSecurityRequirements,
                operationName: "GetValueCountsBackfillStatusAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LabelStudio.PathBuilder(
                                path: "/api/dimensions/value-counts-backfill/status/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetValueCountsBackfillStatusRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetValueCountsBackfillStatus",
                                methodName: "GetValueCountsBackfillStatusAsync",
                                pathTemplate: "\"/api/dimensions/value-counts-backfill/status/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetValueCountsBackfillStatusResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetValueCountsBackfillStatusResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.ValueCountsBackfillJob.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.ValueCountsBackfillJob>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.ValueCountsBackfillJob.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
