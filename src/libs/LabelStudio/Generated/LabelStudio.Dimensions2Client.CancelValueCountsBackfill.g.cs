...
namespace LabelStudio
{
    public partial class Dimensions2Client
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_CancelValueCountsBackfillSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_CancelValueCountsBackfillSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_CancelValueCountsBackfillSecurityRequirement0,
            };
        partial void PrepareCancelValueCountsBackfillArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? jobId,
            ref int? projectId);
        partial void PrepareCancelValueCountsBackfillRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? jobId,
            int? projectId);
        partial void ProcessCancelValueCountsBackfillResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelValueCountsBackfillResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// ✨ Cancel Dimension value-counts backfill jobs<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AgreementV2BackfillCancelResponse> CancelValueCountsBackfillAsync(
            int? jobId = default,
            int? projectId = default,
            global::LabelStudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CancelValueCountsBackfillAsResponseAsync(
                jobId: jobId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LabelStudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.AgreementV2BackfillCancelResponse>> CancelValueCountsBackfillAsResponseAsync(
            int? jobId = default,
            int? projectId = default,
            global::LabelStudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelValueCountsBackfillArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelValueCountsBackfillSecurityRequirements,
                operationName: "CancelValueCountsBackfillAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelValueCountsBackfillRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CancelValueCountsBackfill",
                                methodName: "CancelValueCountsBackfillAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelValueCountsBackfillResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelValueCountsBackfillResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LabelStudio.AgreementV2BackfillCancelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LabelStudio.AutoSDKHttpResponse<global::LabelStudio.AgreementV2BackfillCancelResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LabelStudio.AgreementV2BackfillCancelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
