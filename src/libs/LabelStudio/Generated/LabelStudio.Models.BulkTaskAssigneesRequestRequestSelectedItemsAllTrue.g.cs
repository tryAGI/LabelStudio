...
namespace LabelStudio
{
    ...
    public sealed partial class BulkTaskAssigneesRequestRequestSelectedItemsAllTrue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkTaskAssigneesRequestRequestSelectedItemsAllTrue" /> class.
        /// </summary>
        /// <param name="all">
        /// All tasks are selected
        /// </param>
...
#endif
        public BulkTaskAssigneesRequestRequestSelectedItemsAllTrue(
            bool all,
