...
namespace LabelStudio
{
    public partial class Projects2Client
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LabelStudio.LseProjectUpdate.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LabelStudio.LseProjectUpdate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LabelStudio.LseProjectUpdate> UpdateAsync(
            ...
            global::LabelStudio.AssignmentSettingsRequest? assignmentSettings = default,
