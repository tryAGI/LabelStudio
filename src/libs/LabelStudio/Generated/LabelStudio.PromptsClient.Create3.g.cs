            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LabelStudio.ModelRun.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LabelStudio.ModelRun.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
