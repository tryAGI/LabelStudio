...
namespace LabelStudio
{
    public partial class LearningResourcesClient
    {
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement s_ApiLearningResourcesListSecurityRequirement0 =
        ...
        private static readonly global::LabelStudio.EndPointSecurityRequirement[] s_ApiLearningResourcesListSecurityRequirements =
            new global::LabelStudio.EndPointSecurityRequirement[]
            {                s_ApiLearningResourcesListSecurityRequirement0,
            };
        partial void PrepareApiLearningResourcesListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? ordering,
            ref int? page,
            ref int? pageSize,
            ref string? search);
        partial void PrepareApiLearningResourcesListRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? pageSize,
            string? search);
        partial void ProcessApiLearningResourcesListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessApiLearningResourcesListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// ✨ List learning resources<br/>
        ...
        {
            var __response = await ApiLearningResourcesListAsResponseAsync(
                ordering: ordering,
                page: page,
                pageSize: pageSize,
                search: search,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareApiLearningResourcesListArguments(
            ...
            var __authorizations = global::LabelStudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApiLearningResourcesListSecurityRequirements,
                operationName: "ApiLearningResourcesListAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApiLearningResourcesListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LabelStudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiLearningResourcesList",
                                methodName: "ApiLearningResourcesListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApiLearningResourcesListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LabelStudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApiLearningResourcesListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
